...
void GALBufferImplVk::CreateFromBuilder(GALBufferImplVk::Builder& builder) {
  ...
  VkCommandPool cmd_pool = builder.gal_platform_->GetPlatformDetails()->vk_command_pool;
  ...
  VkQueue graphics_queue = builder.gal_platform_->GetPlatformDetails()->vk_graphics_queue;
